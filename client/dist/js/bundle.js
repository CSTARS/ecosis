...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const P=Object(C.a)(l(Object(r.a)(HTMLElement)));customElements.define("dom-bind",class extends P{static get observedAttributes(){return["mutable-data"]}constructor(){if(super(),h.f)throw new Error("strictTemplatePolicy: dom-bind not allowed");this.root=null,this.$=null,this.__children=null}attributeChangedCallback(){this.mutableData=!0}connectedCallback(){this.style.display="none",this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){Object(c.a)(Object(c.a)(this).parentNode).insertBefore(this.root,this)}__removeChildren(){if(this.__children)for(let t=0;t<this.__children.length;t++)this.root.appendChild(this.__children[t])}render(){let t;if(!this.__children){if(!(t=t||this.querySelector("template"))){let e=new MutationObserver(()=>{if(!(t=this.querySelector("template")))throw new Error("dom-bind requires a <template> child");e.disconnect(),this.render()});return void e.observe(this,{childList:!0})}this.root=this._stampTemplate(t),this.$=this.root.$,this.__children=[];for(let t=this.root.firstChild;t;t=t.nextSibling)this.__children[this.__children.length]=t;this._enableProperties()}this.__insertChildren(),this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}});var k=i(15),L=i(13),M=i(17),E=i(2),T=i(9);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let j;j=a._mutablePropertyChange;Boolean;var D=i(1);i.d(e,"a",function(){return B}),i.d(e,"b",function(){return D.a});
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const B=Object(n.a)(HTMLElement).prototype},function(t,e,i){"use strict";i(7);var n=i(0),r=(i(6),i(32)),o=i(9);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const n=!(window.ShadyDOM&&window.ShadyDOM.inUse);let r,o;function s(t){r=(!t||!t.shimcssproperties)&&(n||Boolean(!navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/)&&window.CSS&&CSS.supports&&CSS.supports("box-shadow","0 0 0 var(--foo)")))}window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(o=window.ShadyCSS.cssBuild);const a=Boolean(window.ShadyCSS&&window.ShadyCSS.disableRuntime);window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?r=window.ShadyCSS.nativeCss:window.ShadyCSS?(s(window.ShadyCSS),window.ShadyCSS=void 0):s(window.WebComponents&&window.WebComponents.flags);const l=r},function(t,e,i){t.exports={BaseModel:i(50),BaseStore:i(52),BaseService:i(54),BaseMixin:i(56),Mixin:i(57),EventBus:i(25),EventInterface:i(58),LitCorkUtils:i(59),fetch:i(41),LightDom:i(60)}},function(t,e,i){"use strict";i.d(e,"c",function(){return a}),i.d(e,"b",function(){return l}),i.d(e,"a",function(){return h});i(7);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function y(t,e){return t?("string"==typeof t&&(t=o(t)),e&&x(t,e),s(t,n.c)):""}function b(t){return!t.__cssRules&&t.textContent&&(t.__cssRules=o(t.textContent)),t.__cssRules||null}function x(t,e,i,n){if(!t)return;let r=!1,o=t.type;if(n&&o===a.MEDIA_RULE){let e=t.selector.match(f.a);e&&(window.matchMedia(e[1]).matches||(r=!0))}o===a.STYLE_RULE?e(t):i&&o===a.KEYFRAMES_RULE?i(t):o===a.MIXIN_RULE&&(r=!0);let s=t.rules;if(s&&!r)for(let t,r=0,o=s.length;r<o&&(t=s[r]);r++)x(t,e,i,n)}function w(t,e){let i=0;for(let n=e,r=t.length;n<r;n++)if("("===t[n])i++;else if(")"===t[n]&&0==--i)return n;return-1}window.ShadyDOM&&window.ShadyDOM.wrap;const S="css-build";function z(t){if(void 0!==n.a)return n.a;if(void 0===t.__cssBuild){const e=t.getAttribute(S);if(e)t.__cssBuild=e;else{const e=function(t){const e="template"===t.localName?t.content.firstChild:t.firstChild;if(e instanceof Comment){const t=e.textContent.trim().split(":");if(t[0]===S)return t[1]}return""}(t);""!==e&&function(t){const e="template"===t.localName?t.content.firstChild:t.firstChild;e.parentNode.removeChild(e)}(t),t.__cssBuild=e}}return t.__cssBuild||""}function C(t){return""!==z(t)}var P=i(18);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const H="_applyShimCurrentVersion",N="_applyShimNextVersion",V="_applyShimValidatingVersion",j=Promise.resolve();function D(t){let e=R[t];e&&function(t){t[H]=t[H]||0,t[V]=t[V]||0,t[N]=(t[N]||0)+1}(e)}function B(t){return t[H]===t[N]}function F(t){return!B(t)&&t[V]===t[N]}function $(t){t[V]=t[N],t._validating||(t._validating=!0,j.then(function(){t[H]=t[N],t._validating=!1}))}i(40);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const O=new class{handleAttributeExpressions(t,e,i,n){const r=e[0];return"."===r?new k(t,e.slice(1),i).parts:"@"===r?[new T(t,e.slice(1),n.eventContext)]:"?"===r?[new P(t,e.slice(1),i)]:new S(t,e,i).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.0.0");const N=(t,...e)=>new y(t,e,"html",O),V=133;function j(t,e){const{element:{content:i},parts:n}=t,r=document.createTreeWalker(i,V,null,!1);let o=B(n),s=n[o],a=-1,l=0;const h=[];let c=null;for(;r.nextNode();){a++;const t=r.currentNode;for(t.previousSibling===c&&(c=null),e.has(t)&&(h.push(t),null===c&&(c=t)),null!==c&&l++;void 0!==s&&s.index===a;)s.index=null!==c?-1:s.index-l,s=n[o=B(n,o)]}h.forEach(t=>t.parentNode.removeChild(t))}const D=t=>{let e=11===t.nodeType?0:1;const i=document.createTreeWalker(t,V,null,!1);for(;i.nextNode();)e++;return e},B=(t,e=-1)=>{for(let i=e+1;i<t.length;i++){const e=t[i];if(m(e))return i}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
</custom-style>`;gt.setAttribute("style","display: none;"),document.head.appendChild(gt.content);var _t=i(28),vt=i.n(_t);let yt=document.createElement("div");yt.style.display="none",yt.innerHTML=vt.a,yt.id="ecosml-style-properties",document.head.appendChild(yt);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</custom-style>`;bt.setAttribute("style","display: none;"),document.head.appendChild(bt.content);var xt=document.createElement("style");xt.textContent="[hidden] { display: none !important; }",document.head.appendChild(xt);var wt=i(5);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
*/Object(wt.a)({_template:pt.a`
    ...
    <slot></slot>
`,is:"iron-pages",behaviors:[te,ne],properties:{activateEvent:{type:String,value:null}},observers:["_selectedPageChanged(selected)"],_selectedPageChanged:function(t,e){this.async(this.notifyResize)}});i(34);var re=i(12);
/**
@license
...
`}.bind(this),this.active=!1,this.organizations=[],this.keywords=[],this.themes=[],this.lastAdded=[],this._injectModel("PackageModel")}updated(t){t.has("active")&&this._onActiveChanged()}async _onActiveChanged(){if(!this.active)return;let t=await this.PackageModel.stats();t=t.payload,this.spectraCount=(t.spectraCount+"").replace(/\B(?=(\d{3})+(?!\d))/g,","),this.lastAdded=t.lastAdded.map(t=>{let e=this.PackageModel.utils.getDefaultSearch();return e.filters.push({"ecosis.organization":t.ecosis.organization}),t.ecosis.organization_link=this.PackageModel.utils.getUrlPathFromQuery(e),t.ecosis.short_description=t.ecosis.description,t.ecosis.short_description.length>250&&(t.ecosis.short_description=t.ecosis.short_description.substr(0,247)+"..."),t}),this.organizations=t["ecosis.organization"].map(t=>this._appendLink(t,"ecosis.organization")),this.keywords=t.Keywords.map(t=>this._appendLink(t,"Keywords")),this.themes=t.Theme.map(t=>this._appendLink(t,"Theme"))}_appendLink(t,e){let i=this.PackageModel.utils.getDefaultSearch();return i.filters.push({[e]:t.value}),t.link=this.PackageModel.utils.getUrlPathFromQuery(i),t}});var oe=i(26),se=i.n(oe);const ae=["Theme","Target Type","Common Name"];customElements.define("app-search-result",class extends(Mixin(st).with(LitCorkUtils)){static get properties(){return{package:{type:Object},organizationLink:{type:String},filters:{type:Array},shortDescription:{type:String}}}constructor(){super(),this.render=function(){return N`
...
`}.bind(this),this._injectModel("PackageModel","AppStateModel"),this.results=[],this.filters=[],this.showNoResults=!1,this.mobileFiltersOpen=!1,window.addEventListener("resize",()=>{let t=window.innerWidth;this.mobileFiltersOpen&&t>768&&(this.mobileFiltersOpen=!1)})}_onPackageSearchUpdate(t){if("loaded"!==t.state)return;this.results=t.payload.items,this.showNoResults=t.payload.total>0,this.total=t.payload.total,this.itemsPerPage=t.payload.stop-t.payload.start,this.currentIndex=t.payload.start;let e=[];for(let i in t.payload.filters)0!==t.payload.filters[i].length&&(t.payload.filters[i].sort((t,e)=>t.count>e.count?-1:t.count<e.count?1:t.filter>e.filter?1:t.filter<e.filter?-1:0),e.push({name:i,label:this.PackageModel.utils.getFilterLabel(i),values:t.payload.filters[i].map(t=>({label:t.filter,count:t.count}))}));this.filters=e}_onPaginationNav(t){let e=this.PackageModel.getCurrentSearchQuery();e.page=t.detail.page-1,this.AppStateModel.setLocation(this.PackageModel.utils.getUrlPathFromQuery(e))}_onOpenLocationClicked(t){this.mobileFiltersOpen=!1,document.querySelector("#locationPopup").open()}_toggleMobileFilters(){this.mobileFiltersOpen=!this.mobileFiltersOpen}_onItemSelected(t){t=t.detail;let e=this.PackageModel.getCurrentSearchQuery();e.filters.push({[t.filter]:t.value.label}),e.page=0,this.AppStateModel.setLocation(this.PackageModel.utils.getUrlPathFromQuery(e))}});customElements.define("app-attr-info-popup",class extends st{static get properties(){return{filter:{type:String},description:{type:String},showing:{type:Boolean}}}constructor(){super(),this.render=function(){return N`
    ...
    <div class="row">
      ...
      <div>
        ...
        ${this.resources.map(t=>N`
          <div><a href="${t.url}" target="_blank" highlight><iron-icon icon="file-download"></iron-icon> ${t.name}</a></div>
        `)}
      </div>
    </div>
...
found at http://polymer.github.io/PATENTS.txt
*/
const ce=Object(wt.a)({_template:pt.a`
    <style>
      :host {
        display: inline-block;
        position: fixed;
...
`;fe.setAttribute("style","display: none;"),document.head.appendChild(fe.content),Object(wt.a)({_template:pt.a`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
found at http://polymer.github.io/PATENTS.txt
*/
Object(wt.a)({is:"paper-input",_template:pt.a`
    <style>
      :host {
        display: block;
      }
...
found at http://polymer.github.io/PATENTS.txt
*/
const xe={observers:["_focusedChanged(receivedFocusFromKeyboard)"],_focusedChanged:function(t){t&&this.ensureRipple(),this.hasRipple()&&(this._ripple.holdDown=t)},_createRipple:function(){var t=Wt._createRipple();return t.id="ink",t.setAttribute("center",""),t.classList.add("circle"),t}},we=[$t,Lt,Wt,xe];var Se=i(21);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
`}.bind(this)}updated(t){(t.has("absMin")||t.has("absMax"))&&this.absMin&&this.absMax&&(this.step=(this.absMax-this.absMin)/10)}reset(){this.min=this.absMin,this.max=this.absMax}_onMinChange(t){let e=parseFloat(t.currentTarget.value);e>this.max?this.min=this.max:this.min=e,this._fireChange()}_onMaxChange(t){let e=parseFloat(t.currentTarget.value);e<this.min?this.max=this.min:this.max=e,this._fireChange()}_fireChange(){let t=new CustomEvent("range-value-change",{detail:{min:this.min,max:this.max}});this.dispatchEvent(t)}});customElements.define("app-spectra-viewer",class extends(Mixin(st).with(LitCorkUtils)){static get properties(){return{active:{type:Boolean},packageId:{type:String},currentSearchCount:{type:Number},currentIndex:{type:Number},mc1:{type:Array},mc2:{type:Array},mobileFiltersOpen:{type:Boolean},packageTitle:{type:String},freezeAxis:{type:Boolean},minWavelength:{type:Number},maxWavelength:{type:Number},absMinWavelength:{type:Number},absMaxWavelength:{type:Number},minReflectance:{type:Number},maxReflectance:{type:Number},absMinReflectance:{type:Number},absMaxReflectance:{type:Number},yAxisLabel:{type:Boolean},speciesFilters:{type:Array},filterCommonName:{type:Array},filterSpecies:{type:Array},filterGenus:{type:Array},selectedSpeciesFilter:{type:Array}}}constructor(){super(),this.render=function(){return N`
...
`}.bind(this),this.active=!1,this.packageId="",this.initTimer=-1,this.redrawTimer=-1,this.currentIndex=0,this.currentSearchCount=0,this.mc1=[],this.mc2=[],this.mobileFiltersOpen=!1,this.minWavelength=0,this.maxWavelength=0,this.absMinWavelength=0,this.absMaxWavelength=0,this.speciesFilters=[],this.filterCommonName=[],this.filterSpecies=[],this.filterGenus=[],this.yAxisLabel="Y Axis",this.minReflectance=0,this.maxReflectance=0,this.absMinReflectance=0,this.absMaxReflectance=0,this.freezeAxis=!1,window.addEventListener("resize",()=>{this.windowInnerWidth=window.innerWidth,this.mobileFiltersOpen&&w>768&&(this.mobileFiltersOpen=!1),this.active&&this.redrawBuffered()}),this._injectModel("GoogleModel","PackageModel","SpectraModel","AppStateModel")}updated(t){t.has("active")&&this.active&&this.loadPackage()}firstUpdated(){this.chartEle=this.shadowRoot.getElementById("chart")}_onAppStateUpdate(t){this.packageId="","package"===t.page&&(t.location.path.length<=1||(this.packageId=t.location.path[1],this.loadPackage()))}async loadPackage(){if(!this.packageId)return;let t=await this.PackageModel.get(this.packageId);"loaded"===t.state&&(this.pkg=t.payload,this.packageTitle=this.pkg.ecosis.package_title,this.speciesFilters=[],this.filterCommonName=this.pkg["Common Name"]||[],this.filterCommonName.sort(),this.filterCommonName.length&&this.speciesFilters.push("Common Name"),this.filterSpecies=this.pkg["Latin Species"]||[],this.filterSpecies.sort(),this.filterSpecies.length&&this.speciesFilters.push("Latin Species"),this.filterGenus=this.pkg["Latin Genus"]||[],this.filterGenus.sort(),this.filterGenus.length&&this.speciesFilters.push("Latin Genus"),this.speciesFilters.length&&this.speciesFilters.unshift(""),this.selectedSpeciesFilter="",this.freezeAxis=!1,this.currentIndex=0,this.totalSpectraCount=this.pkg.ecosis.spectra_count||0,this.filters=[],await this.querySpectra())}async querySpectra(){let t={filters:this.filters,page:this.currentIndex,itemsPerPage:1},e=JSON.stringify(t);if(this.qstr===e)return void this.redraw();this.qstr=e,this.loading=!0;let i=await this.SpectraModel.search(t,this.packageId);if(this.loading=!1,"error"===i.state)return alert(i.error.message);if("loaded"===i.state){if(0===i.payload.items.length)return console.error(i),alert("Failed to load spectra");this.currentSearchCount=i.payload.total,this.renderSpectra(i.payload.items[0])}}async renderSpectra(t){await this.GoogleModel.loadCharts(),this.chart||(this.chart=new google.visualization.LineChart(this.chartEle)),this.metadata=[],this.ecosisMetadata=[],this.wavelengths=[],this.allWavelengths=[];let e=Number.MAX_VALUE,i=Number.MIN_VALUE,n=Number.MAX_VALUE,r=Number.MIN_VALUE;for(let o in t)if("datapoints"===o)for(let o in t.datapoints){let s=parseFloat(o),a=parseFloat(t.datapoints[o]);s<e&&(e=s),s>i&&(i=s),a<n&&(n=a),a>r&&(r=a),this.allWavelengths.push([s,a])}else if("ecosis"===o)for(let e in t.ecosis)this.ecosisMetadata.push({key:e,value:t.ecosis[e]});else{if("_id"===o)continue;this.metadata.push({key:o,value:t[o]})}this.allWavelengths.sort((t,e)=>t[0]>e[0]?1:t[0]<e[0]?-1:0),this.freezeAxis||(this.minReflectance=n,this.maxReflectance=r),this.absMinReflectance=n,this.absMaxReflectance=r,this.updateChartOptions(),this.freezeAxis||(this.maxWavelength=i,this.minWavelength=e),this.absMaxWavelength=i,this.absMinWavelength=e,this.filterWavelenths();let o=[],s=[];this.metadata.forEach((t,e)=>{e%2==0?o.push(t):s.push(t)}),this.mc1=o,this.mc2=s,this.redraw()}redrawBuffered(){-1!==this.redrawTimer&&clearTimeout(this.redrawTimer),this.redrawTimer=setTimeout(()=>{this.redrawTimer=-1,this.redraw()},150)}redraw(){if(!this.chart||!this.chartData||!this.chartOptions)return;this.windowInnerWidth||(this.windowInnerWidth=window.innerWidth);let t=this.windowInnerWidth>1400?1400:this.windowInnerWidth;t-=24,this.windowInnerWidth>768?t-=250:t-=12,this.chartEle.style.width=t+"px",this.chart.draw(this.chartData,this.chartOptions)}updateChartOptions(){let t={legend:{position:"none"},series:{0:{color:"#4db6ac"}},vAxis:{},hAxis:{},tooltip:{isHtml:!0}};this.minReflectance===this.absMinReflectance&&this.maxReflectance===this.absMaxReflectance||(t.vAxis.viewWindow={min:this.minReflectance,max:this.maxReflectance});let e="";this.pkg["Measurement Quantity"]&&1===this.pkg["Measurement Quantity"].length&&(e=this.pkg["Measurement Quantity"][0]),this.pkg["Measurement Units"]&&1===this.pkg["Measurement Units"].length&&(e+=" ("+this.pkg["Measurement Units"][0]+")"),t.vAxis.title=e,this.yAxisLabel=e||"Y Axis",this.pkg["Wavelength Units"]&&1===this.pkg["Wavelength Units"].length&&("other"!==(e=this.pkg["Wavelength Units"][0])?t.hAxis.title="Wavelength ("+e+")":this.pkg["Wavelength Units Other"]&&1===this.pkg["Wavelength Units Other"].length&&(t.hAxis.title="Wavelength ("+this.pkg["Wavelength Units Other"][0]+")")),this.chartOptions=t}filterWavelenths(){this.wavelengths=this.allWavelengths.filter(t=>!(t[0]<this.minWavelength||t[0]>this.maxWavelength)).map(t=>[t[0]+"",t[1]]),this.wavelengths.unshift(["Wavelength","Reflectance"]),this.chartData=google.visualization.arrayToDataTable(this.wavelengths)}_onWavelengthFilterChange(t){this.minWavelength=t.detail.min,this.maxWavelength=t.detail.max,this.filterWavelenths(),this.redraw()}_onPreviousClicked(){this.currentIndex--,this.currentIndex<0&&(this.currentIndex=this.currentSearchCount-1),this.querySpectra()}_onNextClicked(){this.currentIndex++,this.currentIndex===this.currentSearchCount-1&&(this.currentIndex=0),this.querySpectra()}_toggleMobileFilters(){this.mobileFiltersOpen=!this.mobileFiltersOpen}_onSliderValueChange(t){this.currentIndex=t.currentTarget.value-1,this.querySpectra()}_onSelectSpeciesFilterChange(t){if(this.selectedSpeciesFilter=t.currentTarget.value,this.selectedSpeciesFilter){let t="/^"+this.pkg[this.selectedSpeciesFilter][0]+"$/";this.filters=[{[this.selectedSpeciesFilter]:t}]}else this.filters=[];this.currentIndex=0,this.querySpectra()}_onSelectSpeciesValueChange(t){let e=t.currentTarget.value;this.filters=[{[this.selectedSpeciesFilter]:"/^"+e+"$/"}],this.currentIndex=0,this.querySpectra()}_onReflectanceFilterChange(t){this.minReflectance=t.detail.min,this.maxReflectance=t.detail.max,this.updateChartOptions(),this.redraw()}_toggleFreezeAxis(){this.freezeAxis=!this.freezeAxis,this.freezeAxis||(this.minReflectance=this.absMinReflectance,this.maxReflectance=this.absMaxReflectance,this.minWavelength=this.absMinWavelength,this.maxWavelength=this.absMaxWavelength),this.filterWavelenths(),this.updateChartOptions(),this.redraw()}_onResetClicked(){this.freezeAxis=!1,this.minReflectance=this.absMinReflectance,this.maxReflectance=this.absMaxReflectance,this.minWavelength=this.absMinWavelength,this.maxWavelength=this.absMaxWavelength,this.currentIndex=0,this.selectedSpeciesFilter="",this.filters=[],this.querySpectra()}});customElements.define("app-page-result",class extends(Mixin(st).with(LitCorkUtils)){static get properties(){return{view:{type:String}}}constructor(){super(),this.render=function(){return N`
...
found at http://polymer.github.io/PATENTS.txt
*/
Object(wt.a)({is:"paper-icon-button",_template:pt.a`
    <style>
      :host {
        display: inline-block;
        position: relative;
