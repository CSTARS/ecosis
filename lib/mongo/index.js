...
class MongoDB {
  ...
  async conn() {
    ...
    const client = new MongoClient(config.mongo.url, {poolSize: 50});
  ...
  /**
   * @method getPackageId
   * @description get a package by a CKAN generated Id, package
   * name (unique url name), or EcoSIS doi
   * 
   * @param {String} pkgIdOrName
   * 
